 ...
 * <p>See go/mock-objects for general advice on mocking and
 * //google3/apps/framework/testing/mockito/unmockable.bzl for configuration details. When a
 * configured test attempts to Mock a class that is {@code @DoNotMock}, the MockMaker will fail with
 * a detailed error message indicating the alternative testing approach.
