...
public @interface RestrictedApi {
   ...
   * annotate their code with {@code suggestedWhitelistAnnotation}. This annotation should also
   * appear in one of {@link #whitelistAnnotations} or {@link #whitelistWithWarningAnnotations}. Use
   * this automatically whitelist existing callers when introducing a new {@code @RestrictedApi}
   * annotation.
   *
   * <p>In order to run google3-wide refactoring tooling to automatically add whitelist annotations
   * to existing code,
   */
