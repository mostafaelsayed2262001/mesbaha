 ...
 * parameters with this annotation is enforced by <a href="http://go/errorprone">error-prone</a>.
 *
 ...
 * href="http://go/errorprone">error-prone</a>.
 *
 * <p>For example, the following code snippet is legal:
 *
 * <pre>{@code
 ...
 * For advice on designing APIs that consume application-controlled values, contact
 * go/ise-hardening-yaqs.
