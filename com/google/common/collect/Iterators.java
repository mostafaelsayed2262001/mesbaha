...
public final class Iterators {
  ...
  /**
   * Iterates through two iterators in parallel, returning pairs of items. The iterator will return
   * {@code false} for {@code hasNext()} when the end of <i>either</i> iterator is reached. The
   * returned iterator does not support {@code remove()}.
   *
   * @return an iterator that returns pairs of items from the {@code first} and {@code second}
   *     iterators
   */
