...
public final class AndroidAccessToCompactDataStructures {
  ...
  public static <K, V> Map<K, V> newCompactHashMap(int expectedSize) {
  ...
  public static <K, V> Map<K, V> newCompactLinkedHashMap(int expectedSize) {
